export default function Footer() {
  return (
    <footer className="h-10 bg-[#181a25] border-t border-[#2B2B43] flex items-center justify-between px-6 shrink-0 z-40 relative">
      ...
      <div className="flex items-center gap-4 text-xs text-[#d1d4dc]/60">
        ...
        <span className="w-1 h-1 rounded-full bg-[#2B2B43]"></span>
